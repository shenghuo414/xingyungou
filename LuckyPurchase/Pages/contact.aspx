<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="LuckyPurchase.Pages.contact" %>
     ...
     <form id="form1" runat="server">
      <div id="page">
                                ...
                                <nav class="navbar navbar-default">
                                    ...
                                    <div class="collapse navigation navbar-collapse navbar-ex1-collapse remove-space">
                                        <ul class="list-unstyled nav1 cl-effect-10">
                                            ...
                                            <li><a data-hover="联系我们" class="active"><span>联系我们</span></a></li>
                                        </ul>
            ...
            <section class="contact-block">
                <div class="container">
                    <div class="col-md-6 contact-left-block">
                        ...
                        <p class="text-left">我们将带给您最愉快的购买体验，给您最好的服务，用最大的努力回馈你们！</p>
                        <p class="text-right">广南宁市建设发财公司<i class="fa fa-map-marker fa-lg"></i></p>
                        <p class="text-right"><a href="tel:+1-202-555-0100"> 666666 <i class="fa fa-phone fa-lg"></i></a></p>
                        <p class="text-right"><a href="mailto:demo@info.com"> 666666@qq.com <i class="fa fa-envelope"></i></a></p>
                    </div>
                    <div class="col-md-6 contact-form">
                        <h3>您的<span>建议</span></h3>
                        <form action="#" method="post">
                            <input type="text" class="form-control" name="姓名" placeholder="姓名" required=""/>
                            <input type="email" class="form-control" name="手机号码" placeholder="手机号码" required=""/>
                            <textarea class="form-control" name="意见建议" placeholder="意见建议...." required=""></textarea>
        ...
        <footer>
            ...
            <!--back to top--->
						<!-- 代码开始 -->
<%--<div style="float:right" id="leftsead">
				<ul>
					<li>
