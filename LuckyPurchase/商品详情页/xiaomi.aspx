<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xiaomi.aspx.cs" Inherits="LuckyPurchase.商品详情页.xiaomi" %>
...
<div>
                                ...
                                <nav class="navbar navbar-default">
                                    ...
                                    <div class="collapse navigation navbar-collapse navbar-ex1-collapse remove-space">
                                        <ul class="list-unstyled nav1 cl-effect-10">
                                            ...
                                            <li><a data-hover="购买历史" href="../news.aspx"><span>购买历史</span></a></li>
	...
	<div id="xiangqimng">
		...
		<div class="showall">
	                ...
	                <div class="showbot">
                    <div id="showbox">
                        <img src="../images/小米1.jpg" width="400" height="400" />
                        <img src="../images/小米2.jpg" width="400" height="400" />
                        <img src="../images/小米3.jpg" width="400" height="400" />
                        <img src="../images/小米4.jpg" width="400" height="400" />
                        ...
                        <div class="tb-property">
                        	<div class="tr-nobdr">
                        		<h4> 小米12新品5G智能手机 全新一代骁龙8 Gen1 黄金手感 5000万疾速影像 黑色 8GB+256GB</h4>
                        	</div>
                        		<div class="txt">
                        			<span class="nowprice">￥<a href="#">2.00</a>&nbsp;&nbsp;<del class="yuanjia">￥3699</del></span>
                        			<div class="cumulative">
                        				<span class="number ty1">累计售出<br /><em id="add_sell_num_363">540</em></span>
                        				<span class="number tyu">累计评价<br /><em id="Em1">225</em></span>
                        			</div>
                        		</div>
                        	...
                        	<div class="txt-h">
                        		<div class="Progress-bar">
												...
												<ul class="Pro-bar-li">
													<li class="P-bar01"><em>5677</em>已参与人次</li>
													<li class="P-bar02"><em>10099</em>总需人次</li>
													<li class="P-bar03"><em>4022</em>剩余人次</li>
												</ul>
											</div>
												...
												<div id="content" class="active_list"> 
												   ...
												   <!--商品规格-->
												        ...
												        <ul style="display:none;">
												            <li><img src="../images/小米详情1.jpg"/></li>
												            <li><img src="../images/小米详情2.jpg"/></li>
												            <li><img src="../images/小米详情3.jpg"/></li>
												            <li><img src="../images/小米详情4.jpg"/></li>
												 ...
												 <!--商品评价-->      
												    ...
												    <div id="ui-c" class="ui-c">
												          <ul style="display:none;">
												         	<img src="../images/小米保障.jpg" width="943"/>
												         </ul>
												    </div>
												 <!--售后保障-->
