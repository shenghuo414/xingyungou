<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="moto.aspx.cs" Inherits="LuckyPurchase.商品详情页.moto" %>
...
<body>
    <form id="form1" runat="server">
                            ...
                            <div class="social-grid">
                                <ul class="list-unstyled text-right">
                                	<li><asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">登录</asp:LinkButton>&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <a href="../Pages/Backstage.aspx">后台管理</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
		...
		<div class="showall">
	                ...
	                <div class="showbot">
                    <div id="showbox">
                        <img src="../images/moto.jpg" width="400" height="400" />
                        <img src="../images/moto1.jpg" width="400" height="400" />
                        <img src="../images/moto2.jpg" width="400" height="400" />
                        <img src="../images/moto3.jpg" width="400" height="400" />
                        ...
                        <div class="tb-property">
                        	<div class="tr-nobdr">
                        		<h4>摩托罗拉moto edge S30冠军版 骁龙888+ 1亿像素 144Hz电竞屏 5000mAh大电池 5G手机 12GB+512GB 魅影黑</h4>
                        	</div>
                        		<div class="txt">
                        			<span class="nowprice">￥<a href="#">2.00</a>&nbsp;&nbsp;<del class="yuanjia">￥2469</del></span>
                        			<div class="cumulative">
                        				<span class="number ty1">累计售出<br /><em id="add_sell_num_363">370</em></span>
                        				<span class="number tyu">累计评价<br /><em id="Em1">25</em></span>
                        			</div>
                        		</div>
                        	...
                        	<div class="txt-h">
                        		<div class="Progress-bar">
												...
												<ul class="Pro-bar-li">
													<li class="P-bar01"><em>4677</em>已参与人次</li>
													<li class="P-bar02"><em>8699</em>总需人次</li>
                        		...
                        		<ul class="glist" id="glist" data-monitor="goodsdetails_fenlei_click">
                        			<li><a title="红色512g" href="#">黑色</a></li>
                        			<li><a title="蓝色128g" href="#">蓝色</a></li>
                        		</ul>
                        	</div>
                        	<script>
                        	    $(document).ready(function () {
												...
												<div id="content" class="active_list"> 
												   ...
												   <!--商品规格-->
												        ...
												        <ul style="display:none;">
												            <li><img src="../images/摩托1.png"/></li>
												            <li><img src="../images/摩托2.png"/></li>
												            <li><img src="../images/摩托3.png"/></li>
												            <li><img src="../images/摩托4.png"/></li>
												 ...
												 <!--商品评价-->      
												    ...
												    <div id="ui-c" class="ui-c">
												          <ul style="display:none;">
												         	<img src="../images/moto保障.jpg" width="943"/>
												         </ul>
												    </div>
												 <!--售后保障-->
