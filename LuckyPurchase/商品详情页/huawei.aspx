<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="huawei.aspx.cs" Inherits="LuckyPurchase.商品详情页.huawei" %>
    ...
    <form id="form1" runat="server">
	 ...
	 <div id="xiangqimng">
		...
		<div class="showall">
	                ...
	                <div class="showbot">
                    <div id="showbox">
                        <img src="../images/huawei1.jpg" width="400" height="400" />
                        <img src="../images/huawei2.jpg" width="400" height="400" />
                        <img src="../images/huawei3.jpg" width="400" height="400" />
                        <img src="../images/huawei4.jpg"  width="400" height="400" />
                        ...
                        <div class="tb-property">
                        	<div class="tr-nobdr">
                        		<h4>HUAWEI P50 原色双影像单元 搭载HarmonyOS 2 万象双环设计 支持66W超级快充 8GB+128GB曜金黑 华为手机</h4>
                        	</div>
                        		<div class="txt">
												...
												<div id="content" class="active_list"> 
												   ...
												   <!--商品规格-->
												        ...
												        <ul style="display:none;">
												            <li><img src="../images/huawei规格1.jpg"/></li>
												            <li><img src="../images/huawei规格2.jpg"/></li>
												            <li><img src="../images/huawei规格3.jpg"/></li>
												            <li><img src="../images/huawei规格4.jpg"/></li>
												 ...
												 <!--商品评价-->      
												    ...
												    <div id="ui-c" class="ui-c">
												          <ul style="display:none;">
												         	<img src="../images/huawei保障.jpg" width="943"/>
												         </ul>
												    </div>
												 <!--售后保障-->
