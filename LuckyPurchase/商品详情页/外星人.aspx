<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="外星人.aspx.cs" Inherits="LuckyPurchase.商品详情页.外星人" %>
 ...
 <div>
	...
	<div id="xiangqimng">
		...
		<div class="showall">
	                ...
	                <div class="showbot">
                    <div id="showbox">
                        <img src="../images/外星人1.png" width="400" height="400" />
                        <img src="../images/外星人2.png" width="400" height="400" />
                        <img src="../images/外星人3.png" width="400" height="400" />
                        <img src="../images/外星人4.png" width="400" height="400" />
                        ...
                        <div class="tb-property">
                        	<div class="tr-nobdr">
                        		<h4>外星人（alienware） 全新x17R2笔记本电脑17.3英寸12代酷睿高端旗舰电竞轻薄游戏本</h4>
                        	</div>
                        		<div class="txt">
                        			<span class="nowprice">￥<a href="#">2.00</a>&nbsp;&nbsp;<del class="yuanjia">￥54999</del></span>
                        			<div class="cumulative">
                        				<span class="number ty1">累计售出<br /><em id="add_sell_num_363">350</em></span>
                        				<span class="number tyu">累计评价<br /><em id="Em1">241</em></span>
                        			</div>
                        		</div>
                        	...
                        	<div class="txt-h">
                        		<div class="Progress-bar">
												...
												<ul class="Pro-bar-li">
													<li class="P-bar01"><em>4197</em>已参与人次</li>
													<li class="P-bar02"><em>6959</em>总需人次</li>
													<li class="P-bar03"><em>2822</em>剩余人次</li>
												</ul>
											</div>
                        		<span class="tex-o">颜色:</span>
                        		<ul class="glist" id="glist" data-monitor="goodsdetails_fenlei_click">
                        			<li><a title="红色36g" href="#">白色</a></li>
                        	...
                        	</div><%--class="addcart hu"--%>
                        	<div <%--class="nobdr-btns"--%>>
                                <div style="width:200px;height:35px ;background-color:orangered;margin-left:64px">
                                    <asp:LinkButton ID="LinkButton3"  style="margin-left:50px;line-height:35px;color:white;" runat="server" OnClick="LinkButton3_Click"><img src="images/shop.png" width="25" height="25"/>加入购物车</asp:LinkButton>
                                </div>
                                 <div style="width:200px;height:35px ;background-color:orangered;margin-left:266px;margin-top:-35px">
                                    <asp:LinkButton ID="LinkButton4"  style="margin-left:50px;line-height:35px;color:white;" runat="server" OnClick="LinkButton4_Click"><img src="images/ht.png" width="25" height="25"/>立即购买</asp:LinkButton>
                                </div>
                        	</div>
                		...
                		<div class="active_tab" id="outer">
												...
												<div id="content" class="active_list"> 
													...
													<div id="ui-a" class="ui-a">
												        ...
												        <li>商品名称：外星人（alienware）X17-R2</li>
												        <li>商品型号： 外星人</li>
												        <li>品牌:外星人</li>
												        <li>上架时间：2022-5-5</li>
												        <li>库存： 469 </li>
												   ...
												   <!--商品规格-->
												        ...
												        <ul style="display:none;">
												            <li><img src="../images/外星人详情1.jpg"/></li>
                                                            <li><img src="../images/外星人详情2.jpg"/></li>
                                                            <li><img src="../images/外星人详情3.jpg"/></li>
                                                            <li><img src="../images/外星人详情4.jpg"/></li>
