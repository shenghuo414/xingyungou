<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="苹果电脑.aspx.cs" Inherits="LuckyPurchase.商品详情页.苹果电脑" %>
...
<body>
	...
	<div id="xiangqimng">
		...
		<div class="showall">
	                ...
	                <div class="showbot">
                    <div id="showbox">
                        <img src="../images/mac1.png" width="400" height="400" />
                        <img src="../images/mac2.png" width="400" height="400" />
                        <img src="../images/mac3.png" width="400" height="400" />
                        <img src="../images/mac4.png" width="400" height="400" />
                        ...
                        <div class="tb-property">
                        	<div class="tr-nobdr">
                        		<h4>Apple MacBook Pro 14英寸 M1 Pro芯片(8核中央处理器 14核图形处理器) 16G 512G 深空灰 笔记本 MKGP3CH/A</h4>
                        	</div>
                        		<div class="txt">
                        			<span class="nowprice">￥<a href="#">2.00</a>&nbsp;&nbsp;<del class="yuanjia">￥14999</del></span>
                        			<div class="cumulative">
                        				<span class="number ty1">累计售出<br /><em id="add_sell_num_363">230</em></span>
                        				<span class="number tyu">累计评价<br /><em id="Em1">119</em></span>
                        			</div>
                        		</div>
                        	...
                        	<div class="txt-h">
                        		<div class="Progress-bar">
												...
												<ul class="Pro-bar-li">
													<li class="P-bar01"><em>1477</em>已参与人次</li>
													<li class="P-bar02"><em>4099</em>总需人次</li>
													<li class="P-bar03"><em>2622</em>剩余人次</li>
												</ul>
											</div>
                        		<span class="tex-o">颜色:</span>
                        		<ul class="glist" id="glist" data-monitor="goodsdetails_fenlei_click">
                        			<li><a title="红色36g" href="#">粉色</a></li>
                		...
                		<div class="active_tab" id="outer">
												...
												<div id="content" class="active_list"> 
													...
													<div id="ui-a" class="ui-a">
												        ...
												        <li>商品名称：AppleMacBook Pro</li>
												        <li>商品型号： Apple-MacBook Pro</li>
												        <li>品牌:苹果</li>
												        <li>上架时间：2022-5-5</li>
												        <li>库存： 209 </li>
												   ...
												   <!--商品规格-->
												        ...
												        <ul style="display:none;">
												            <li><img src="../images/mac详情.jpg"/></li>
